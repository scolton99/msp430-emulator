...
MSP430::Instruction<msp430_size_t>* process_opcode(MSP430::msp430_word_t extension_word,
  ...
  if (short_code == 0x00) {
    switch (x_instr_id) {
      ...
      case 0b1000:
      case 0b1100:
        return new MSP430::MOVAInstruction<msp430_size_t>(raw_instruction);
      case 0b0100:
      case 0b0101: {
        switch (x_instr_sub_id) {
          case 0b00:
            return new MSP430::RRCMInstruction<msp430_size_t>(raw_instruction);
          case 0b01:
            return new MSP430::RRAMInstruction<msp430_size_t>(raw_instruction);
          case 0b10:
            return new MSP430::RLAMInstruction<msp430_size_t>(raw_instruction);
          case 0b11:
            return new MSP430::RRUMInstruction<msp430_size_t>(raw_instruction);
          default:
      ...
      case 0b1001:
      case 0b1101:
        return new MSP430::CMPAInstruction<msp430_size_t>(raw_instruction);
      case 0b1010:
      case 0b1110:
        return new MSP430::ADDAInstruction<msp430_size_t>(raw_instruction);
      case 0b1011:
      case 0b1111:
        return new MSP430::SUBAInstruction<msp430_size_t>(raw_instruction);
      default:
    ...
    switch (opcode_x_10) {
      ...
      case 0x134:
        return new MSP430::CALLAInstruction<msp430_size_t>(raw_instruction);
      default:
    ...
    switch (pushm_popm_id) {
      case 0b00:
      case 0b01:
        return new MSP430::PUSHMInstruction<msp430_size_t>(raw_instruction);
      case 0b10:
      case 0b11:
        return new MSP430::POPMInstruction<msp430_size_t>(raw_instruction);
      default:
        throw std::runtime_error("Should be impossible");
    }
    ...
    return new MSP430::JNEInstruction<msp430_size_t>(raw_instruction);
  } else if (opcode == 0x24) {
    return new MSP430::JEQInstruction<msp430_size_t>(raw_instruction);
  } else if (opcode == 0x28) {
    return new MSP430::JNCInstruction<msp430_size_t>(raw_instruction);
  } else if (opcode == 0x2C) {
    return new MSP430::JCInstruction<msp430_size_t>(raw_instruction);
  } else if (opcode == 0x30) {
    return new MSP430::JNInstruction<msp430_size_t>(raw_instruction);
  } else if (opcode == 0x34) {
    return new MSP430::JGEInstruction<msp430_size_t>(raw_instruction);
  } else if (opcode == 0x38) {
    return new MSP430::JLInstruction<msp430_size_t>(raw_instruction);
  } else if (opcode == 0x3C) {
    return new MSP430::JMPInstruction<msp430_size_t>(raw_instruction);
...
MSP430::Instruction<msp430_size_t>* MSP430::instruction_decode(Package* package, msp430_addr_t loc) {
  ...
  package->get_cpu()->get_pc()->set_value(loc, sizeof(msp430_addr_t));

  return process_opcode<msp430_size_t>(extension_word, raw_instruction);
}

template MSP430::Instruction<MSP430::msp430_byte_t>*      MSP430::instruction_decode<MSP430::msp430_byte_t>(Package* package, msp430_addr_t loc);
template MSP430::Instruction<MSP430::msp430_word_t>*      MSP430::instruction_decode<MSP430::msp430_word_t>(Package* package, msp430_addr_t loc);
template MSP430::Instruction<MSP430::msp430_addr_word_t>* MSP430::instruction_decode<MSP430::msp430_addr_word_t>(Package* package, msp430_addr_t loc);